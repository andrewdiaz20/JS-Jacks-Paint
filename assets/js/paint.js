function configureListeners(colors) {
    let images = document.getElementByTagName('img')// select img elements  
...
function getProductInfo(paintColor) {
    ...
    {       
        ...
        color.textContext = colorName;// select element with corresponding id
        //display color name
    }
